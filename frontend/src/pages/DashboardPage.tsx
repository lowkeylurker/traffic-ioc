      ...
      {userScore && (
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <span style={{ fontSize: 11, fontWeight: 600, color: '#fcd34d', textTransform: 'uppercase', letterSpacing: 0.5 }}>
              Hiệp Sĩ Giao Thông
            </span>
            <Space align="center" size={6}>
              <span style={{ fontSize: '1.2rem' }}>🏆</span>
              <span style={{ color: '#fff', fontWeight: 800, fontSize: 18, textShadow: '0 2px 4px rgba(0,0,0,0.5)' }}>
          ...
          <Tooltip title={`Uy tín ẩn (Elo): ${userScore.trustWeight.toFixed(1)}. Tăng lên khi bạn xác nhận đúng sự cố.`} placement="bottom">
            <div style={{ cursor: 'help', display: 'flex', alignItems: 'center', justifyContent: 'center', width: 36, height: 36, borderRadius: '50%', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)' }}>
              <span style={{ fontSize: 18, filter: 'drop-shadow(0 0 4px rgba(56, 189, 248, 0.6))' }}>🛡️</span>
            </div>
          </Tooltip>
        </div>
      )}
