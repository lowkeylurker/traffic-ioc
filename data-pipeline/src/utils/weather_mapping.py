...
DEPRECATED: This module is deprecated. Use src.domain.weather instead.
  - Constants: from src.domain.weather.mapping import ICON_CATEGORY_MAP
  - Functions: from src.domain.weather import ...
...
warnings.warn(
    "weather_mapping module is deprecated. Use src.domain.weather instead.",
    DeprecationWarning,
    stacklevel=2,
)
