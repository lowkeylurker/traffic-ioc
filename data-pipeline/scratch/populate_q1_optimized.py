...
with engine.begin() as conn:
    ...
    # Using a slightly larger BBOX to ensure we catch all segments of these roads 
    # that are realistically within or bordering District 1.
    insert_sql = text("""
    ...
    print(f"Optimized Coverage population finished. Total segments: {result.rowcount}")
