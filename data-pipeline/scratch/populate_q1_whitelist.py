...
with engine.begin() as conn:
    ...
    # We use spatial filter to ensure they are in District 1 area, 
    # and filter by road name from your list.
    insert_sql = text("""
        INSERT INTO dim_segment_q1 (segment_key, geometry_center)
        SELECT s.segment_key, s.geometry_center
        FROM dim_segment s
    ...
    print(f"Successfully populated dim_segment_q1 with {result.rowcount} segments from your list.")
