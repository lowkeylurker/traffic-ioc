...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Images/Ch6/1.png}
    \vspace{12pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Images/Ch6/2.png}
    \vspace{12pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Images/Ch6/5.png}
    \vspace{12pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Images/Ch6/3.png}
    \vspace{12pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Images/Ch6/9.png}
    \vspace{12pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Images/Ch6/11.png}
    \vspace{12pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Images/Ch6/6.png}
    \includegraphics[width=0.9\textwidth]{Images/Ch6/7.png}
    \vspace{12pt}
    \caption{Giao diện Nghiệp vụ Mô phỏng \& Dự báo với kiến trúc Dual-Map}
    \label{fig:admin_predictive}
\end{figure}
...
\begin{itemize}
    ...
    \item \textbf{$\alpha \times Distance$ (Hệ số phạt đường vòng):} Với hệ số $\alpha = 0.02$ (tương đương đi vòng 1km sẽ bị phạt cộng thêm 20 giây vào $Cost$). Giá trị này được thiết lập dựa trên khái niệm \textbf{Giá trị Thời gian (Value of Travel Time - VoT)}. Nếu chỉ tối ưu bằng thời gian thuần túy, thuật toán sẽ có xu hướng lùa xe vào các ngõ hẻm nhỏ hẹp để tiết kiệm vài giây (hiện tượng Rat-running). Trọng số này ép thuật toán ưu tiên lộ trình thẳng/ngắn nhất.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Images/Ch6/13.png}
    \vspace{12pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Images/Ch6/14.png}
    \vspace{12pt}
