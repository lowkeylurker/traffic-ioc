...
\subsection{Cơ sở lý thuyết thuật toán và hệ thống}
...
\textbf{a. Lý thuyết Đồ thị và Thuật toán Tìm đường (Routing Algorithms)}
...
\textbf{b. Lý thuyết Xử lý Phân tích Trực tuyến (OLAP)}
...
\textbf{c. Xử lý Không gian và Khớp bản đồ (Map Matching)}
...
\subsubsection{Công nghệ xây dựng Máy chủ (Backend Framework)}
...
\subsubsection{Công nghệ xây dựng Giao diện (Frontend Framework)}
...
\subsubsection{Công nghệ Triển khai và Đám mây (Deployment \& Cloud Services)}
