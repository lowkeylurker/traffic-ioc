...
# ==========================================
# KHỐI TEST NHANH MÔI TRƯỜNG & MA TRẬN REWARD
# ==========================================
if __name__ == "__main__":
    ...
    # Khởi tạo môi trường rỗng chỉ để test hàm reward
    env_mock = TrafficForecastingEnv(dataloader=[]) 
    
    # Định nghĩa tên các mức độ để in ra cho đẹp
    level_names = {
        0: "Mức 0 (Rất thoáng)",
        1: "Mức 1 (Thoáng)",
        2: "Mức 2 (Hơi đông)",
    ...
    # Duyệt qua 6 mức thực tế
    for target in range(6):
        # Duyệt qua 6 mức dự báo
        for action in range(6):
            reward = env_mock.calculate_reward(action, target)
            
            # Phân loại logic để in giải thích
        ...
        print("-" * 90) # Đường gạch ngang phân cách các nhóm Target